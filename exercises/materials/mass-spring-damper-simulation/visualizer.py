...
class Visualizer(object):
    def __init__(self, callback=None, interval=100.0, simulation_time=20.0, initial=(0, 0, 0, 0, 0, 0)):
        ...
        # Create info text
        self.acceleration_plot.text(0.85, 0.8,'Red: Ax\nBlue: Yy',transform=self.acceleration_plot.transAxes)
    ...
    def animate(self, i):
        ...
        # if self.sim_time >= self.simulation_time:
        #     self.animate.event_source.stop()
        #     return self.patch, self.x_patch, self.y_patch, self.sim_time_label,
